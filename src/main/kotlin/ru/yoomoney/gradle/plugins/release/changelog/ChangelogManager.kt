...
class ChangelogManager(private val changeLog: File) {
    ...
    /**
     * Присутствует ли в CHANGELOG.MD секция **breaking changes** при мажорном изменении
     */
    fun hasBreakingChangesWhenMajor(): Boolean {
        if (getNextVersionType() == ReleaseType.MAJOR) {
